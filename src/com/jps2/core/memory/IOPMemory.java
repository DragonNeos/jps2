...
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_FW_END;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_FW_START;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_SPU2_END;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_SPU2_START;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_USB_END;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HW_USB_START;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA10_BCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA10_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA10_MADR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA2_BCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA2_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA2_MADR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA3_BCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA3_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA3_MADR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA4_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA7_BCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA7_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA9_BCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA9_CHCR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA9_MADR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.HWx_DMA9_TADR;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T0_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T0_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T0_TARGET;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T1_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T1_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T1_TARGET;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T2_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T2_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T2_TARGET;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T3_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T3_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T3_TARGET;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T4_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T4_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T4_TARGET;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T5_COUNT;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T5_MODE;
import static com.jps2.core.cpu.r3000a.HardwareRegisters.IOP_T5_TARGET;
...
public class IOPMemory extends FastMemory {
	...
	public int read32(int address) {
		...
		switch (address) {
		case 0x1040:
			hard = JPS2.getSio().sioRead8();
			hard |= JPS2.getSio().sioRead8() << 8;
			hard |= JPS2.getSio().sioRead8() << 16;
			hard |= JPS2.getSio().sioRead8() << 24;
		...
		case IOP_T0_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount16(0);
			System.err.printf("T0 count read32: %x", hard);
			return hard;
		case IOP_T0_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(0).mode;
			System.err.printf("T0 mode read32: %x", hard);
			return hard;
		case IOP_T0_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(0).target;
			System.err.printf("T0 target read32: %x", hard);
			return hard;
		case IOP_T1_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount16(1);
			System.err.printf("T1 count read32: %x", hard);
			return hard;
		case IOP_T1_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(1).mode;
			System.err.printf("T1 mode read32: %x", hard);
			return hard;
		case IOP_T1_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(1).target;
			System.err.printf("T1 target read32: %x", hard);
			return hard;
		case IOP_T2_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount16(2);
			System.err.printf("T2 count read32: %x", hard);
			return hard;
		case IOP_T2_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(2).mode;
			System.err.printf("T2 mode read32: %x", hard);
			return hard;
		case IOP_T2_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(2).target;
			System.err.printf("T2 target read32: %x", hard);
			return hard;
		case IOP_T3_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount32(3);
			System.err.printf("T3 count read32: %x", hard);
			return hard;
		case IOP_T3_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(3).mode;
			System.err.printf("T3 mode read32: %x", hard);
			return hard;
		case IOP_T3_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(3).target;
			System.err.printf("T3 target read32: %x", hard);
			return hard;
		case IOP_T4_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount32(4);
			System.err.printf("T4 count read32: %x", hard);
			return hard;
		case IOP_T4_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(4).mode;
			System.err.printf("T4 mode read32: %x", hard);
			return hard;
		case IOP_T4_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(4).target;
			System.err.printf("T4 target read32: %x", hard);
			return hard;
		case IOP_T5_COUNT:
			hard = R3000a.getProcessor().cpu.psxRcntRcount32(5);
			System.err.printf("T5 count read32: %x", hard);
			return hard;
		case IOP_T5_MODE:
			hard = (short) R3000a.getProcessor().cpu.getCounter(5).mode;
			System.err.printf("T5 mode read32: %x", hard);
			return hard;
		case IOP_T5_TARGET:
			hard = (int) R3000a.getProcessor().cpu.getCounter(5).target;
			System.err.printf("T5 target read32: %x\r\n", hard);
			return hard;

		case 0x1450:
			hard = super.read32(address);
			System.err.printf("%08X ICFG 32bit read %x\r\n", R3000a.getProcessor().cpu.getPc(), hard);
			return hard;
	...
	public void write16(int address, final short data) {
		...
		switch (address) {
		case 0x1040:
			JPS2.getSio().sioWrite8((byte) data);
			JPS2.getSio().sioWrite8((byte) (data >> 8));
		...
		case 0x1044:
			...
			return;
		case 0x1048:
			JPS2.getSio().modeReg = data;
			System.err.printf("sio write16 %x, %x", address & 0xf, data);
			return;
		case 0x104a: // control register
			JPS2.getSio().sioWriteCtrl16(data);
			System.err.printf("sio write16 %x, %x", address & 0xf, data);
			return;
		case 0x104e: // baudrate register
			JPS2.getSio().baudReg = data;
			System.err.printf("sio write16 %x, %x", address & 0xf, data);
			return;
		...
		case 0x1074:
			...
			R3000a.getProcessor().cpu.iopTestIntc();
			return;
	...
	public void write32(int address, final int data) {
		...
		switch (address) {
		case 0x1040:
			JPS2.getSio().sioWrite8((byte) (data & 0xff));
			JPS2.getSio().sioWrite8((byte) ((data & 0xff00) >> 8));
			JPS2.getSio().sioWrite8((byte) ((data & 0xff0000) >> 16));
			JPS2.getSio().sioWrite8((byte) ((data & 0xff000000) >> 24));
