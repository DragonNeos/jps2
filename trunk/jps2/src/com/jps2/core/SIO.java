        ...
        switch (mcdst) {
                ...
                Arrays.fill(buffer, (byte)0xff);
                        ...
                        default:
                                ...
                                Arrays.fill(buffer, (byte)0xff);
                                buffer[bufcount]=terminator; buffer[bufcount-1]='+';
                                System.err.printf("Unknown MC(%d) command 0x%02X", getMemcardIndex()+1, value);
                        }
                        mcCommand=value;
                        return;
                ...
                if (parp==2)sector|=(value & 0xFF)<< 0;
                                ...
                                if (parp==6)
                                {
                                        if (sio_xor((byte)&sector, 4) == value)
                                                System.err.printf("MC(%d) SET PAGE sector, sector=0x%04X", getMemcardIndex()+1, sector);
                                        else
                                                System.err.printf("MC(%d) SET PAGE XOR value ERROR 0x%02X != ^0x%02X",
                                                        GetMemcardIndex()+1, value, sio_xor((u8 *)&sector, 4));
                                }
                                break;
                        ...
                        case 0x27:
                                if(parp==2) {
                                        terminator = value;
                                        buf[4] = value;
                                        System.err.printf("MC(%d) SET TERMINATOR command, value=0x%02X", GetMemcardIndex()+1, value);
                        ...
                        case 0x28:
                                if(parp == 2) {
                                        ...
                                        buf[4] = 0x55;
                                        System.err.printf("MC(%d) GET TERMINATOR command, value=0x%02X", GetMemcardIndex()+1, value);
                                }
                                break;
                        // WRITE DATA
                        case 0x42:
                                if (parp==2) {
                                        ...
                                        System.err.printf("MC(%d) WRITE command, size=0x%02X", GetMemcardIndex()+1, value);
                                }
                                else
                        ...
                        case 0x43:
                                if (parp==2)
                                {
                                        ...
                                        bufcount=value+5;
                                        buf[3]='+';
                                        System.err.printf("MC(%d) READ command, size=0x%02X", GetMemcardIndex()+1, value);
                        ...
                        case 0x82:
                                ...
                                /*      memset(buf, -1, 256);
                                        ...
                                        buf[3]=terminator;*/
                                        //buf[bufcount] = terminator;
                                        System.err.printf("MC(%d) INTERNAL ERASE command 0x%02X", GetMemcardIndex()+1, value);
                                }
                                break;
                        ...
                        case 0xF0:
                                if (parp==2)
                                {
                                        System.err.printf("MC(%d) CARD AUTH :0x%02X", GetMemcardIndex()+1, value);
                                        switch(value){
                                        case  1:
                                        case  2:
                                        case  4:
