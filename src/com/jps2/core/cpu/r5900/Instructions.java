...
public class Instructions {
	...
	public static final Instruction	BVF	      = new Instruction(FLAGS_BRANCH_INSTRUCTION) {
	...
	public static final Instruction	BVT	      = new Instruction(FLAGS_BRANCH_INSTRUCTION) {
	...
	public static final Instruction	BVFL	  = new Instruction(FLAGS_BRANCH_INSTRUCTION) {
	...
	public static final Instruction	BVTL	  = new Instruction(FLAGS_BRANCH_INSTRUCTION) {
