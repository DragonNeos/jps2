...
public class R5900 {
	 ...
	 */
	public static boolean	           ENABLE_INSN_EXECUTE_COUNT	= true;
	...
	private static R5900	processor;

	public static R5900 getProcessor() {
		if (processor == null) {
			processor = new R5900();
		}
	...
	public void invalidateICache() {
		if (insnCount != 0) {
			R5900.log.info("icache hits:" + insnCacheHits + " (" + (insnCacheHits * 100 / insnCount) + "%)" + " misses:" + insnCacheMisses + " (" + (insnCacheMisses * 100 / insnCount) + "%)");
		}
